...
public:
	...
	friend void to_json(nlohmann::json& nlohmann_json_j,
						const UpdatePackageBuildInfo& nlohmann_json_t) {
	...
	friend void from_json(const nlohmann::json& nlohmann_json_j,
						  UpdatePackageBuildInfo& nlohmann_json_t) {
		UpdatePackageBuildInfo nlohmann_json_default_obj;
		nlohmann_json_t.PackageMode = nlohmann_json_j.value(
			"PackageMode", nlohmann_json_default_obj.PackageMode);
		nlohmann_json_t.OldVersionPath = nlohmann_json_j.value(
			"OldVersionPath", nlohmann_json_default_obj.OldVersionPath);
		nlohmann_json_t.NewVersionPath = nlohmann_json_j.value(
			"NewVersionPath", nlohmann_json_default_obj.NewVersionPath);
		nlohmann_json_t.AppName =
			nlohmann_json_j.value("AppName", nlohmann_json_default_obj.AppName);
		nlohmann_json_t.Channel =
			nlohmann_json_j.value("Channel", nlohmann_json_default_obj.Channel);
		nlohmann_json_t.Platform = nlohmann_json_j.value(
			"Platform", nlohmann_json_default_obj.Platform);
