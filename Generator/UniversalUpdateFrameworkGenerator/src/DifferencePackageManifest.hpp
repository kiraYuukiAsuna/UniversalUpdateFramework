...
public:
    ...
    friend void to_json(nlohmann::json&nlohmann_json_j, const DifferencePackageManifestInfo&nlohmann_json_t) {
    ...
    friend void from_json(const nlohmann::json&nlohmann_json_j, DifferencePackageManifestInfo&nlohmann_json_t) {
        ...
        nlohmann_json_t.AppCurrentVersion = nlohmann_json_j.value("AppCurrentVersion", nlohmann_json_default_obj.AppCurrentVersion);
